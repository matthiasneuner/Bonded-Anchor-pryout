...
band_x = 50.0e1         # Thickness of the solid refined block in front of the anchor (x-dir)
band_y = 15.0e1         # Thickness of the refined shell from the top surface (y-dir)
