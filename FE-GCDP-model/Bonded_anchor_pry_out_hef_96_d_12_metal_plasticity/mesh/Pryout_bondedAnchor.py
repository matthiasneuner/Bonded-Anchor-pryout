...
slab_h = 200.0        # Total height (y)

# Borehole & Mortar
hole_r = 7.0          # Borehole radius
hole_d = 96.0         # Borehole depth
anchor_d = 96.0       # Depth of the anchor within the borehole (must be <= hole_d)

# Refinement Region
refine_r = 100.0       # Radius of the inner refined concrete region

# Steel Anchor
anchor_r = 6.0        # Anchor radius
anchor_free_h = 12.0  # Anchor height above the concrete slab

# Steel Plate
plate_w = 48.0        # Plate width (x and z)
plate_h = 12.0        # Plate thickness (y)
