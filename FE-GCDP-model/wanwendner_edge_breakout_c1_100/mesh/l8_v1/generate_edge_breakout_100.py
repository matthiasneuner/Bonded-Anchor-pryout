...
csv_tolerance = 7.5                     # Distance radius to match current elements to the imported centroids
...
nearfield_x = edge_dist + 100.0  # Length of the near field region in the x-direction (from free edge to start of far field)
...
if refine_sleeve:
    ...
    borehole_hexes = [h for h in borehole_hexes if cubit.get_center_point("hex", h)[1] > (-anchor_d - 40.01)]
