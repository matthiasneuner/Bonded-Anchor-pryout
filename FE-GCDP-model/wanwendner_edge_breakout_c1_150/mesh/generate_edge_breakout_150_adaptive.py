...
far_y = 50.0        # Size of far field in -y direction
...
nearfield_h = 250    # Total height (y)
...
# Mesh Parameters
mesh_size_steel = 4.0
mesh_size_concrete_outer = 12.5  # Base size for the concrete block
...
if refine_sleeve:
    ...
    borehole_hexes = [h for h in borehole_hexes if cubit.get_center_point("hex", h)[1] > (-anchor_d - 60.01)]
